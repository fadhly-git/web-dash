...
module.exports = {
  mode: "jit",
  content: [
    './pages/**/*.{js,ts,jsx,tsx}', // Untuk Next.js dengan struktur pages
    './components/**/*.{js,ts,jsx,tsx}', // Untuk komponen di folder components
    './app/**/*.{js,ts,jsx,tsx}', // Untuk Next.js dengan struktur app
  ],
  presets: [],
  darkMode: "class",
  theme: {
